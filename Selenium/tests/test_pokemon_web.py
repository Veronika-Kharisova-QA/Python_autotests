...
def test_positive_login():
    ...
    email.click()
    email.send_keys('EMAIL') # введи тут email своего тестового аккаунта на stage окружении
    ...
    password.click()
    password.send_keys('PASSWORD') # введи тут пароль своего тестового аккаунта на stage окружении
    ...
    assert trainer_id.text.replace('\n', ': ') == 'ID: 1', 'Unexpected ID trainer' # введи тут ID своего тренера